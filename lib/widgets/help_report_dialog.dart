...
typedef HelpReportSubmitter = Future<void> Function({
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            submitter == null
                ? 'Help reporting will be connected later.'
                : 'Thanks — your help report was sent.',
          ),
        ),
      );
    } catch (e) {
          ...
          children: [
            ...
            TextField(
              ...
              decoration: const InputDecoration(
                ...
                hintText:
                    'Example: I clicked Save Member and got a red error...',
