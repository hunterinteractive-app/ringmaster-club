...
class MyHelpRequestsButton extends StatefulWidget {
  const MyHelpRequestsButton({
    ...
    this.iconColor,
    this.textColor,
    this.onOpenHelpRequests,
  });

  final bool showLabel;
  final Color? iconColor;
  final Color? textColor;
  final VoidCallback? onOpenHelpRequests;
...
class _MyHelpRequestsButtonState extends State<MyHelpRequestsButton> {
  ...
  Future<void> _openHelpRequests() async {
    final customHandler = widget.onOpenHelpRequests;
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        content: Text('My help requests will be added later.'),
      ),
    );
  }
